...
export default function Home() {
  ...
  return (
    <div className="min-h-screen bg-background gradient-mesh flex flex-col relative overflow-hidden">
      ...
      <div
        className="absolute top-1/2 -right-48 w-[500px] h-[500px] bg-gradient-to-br from-[hsl(264,80%,58%,0.12)] to-transparent rounded-full blur-3xl pointer-events-none"
        style={{ animationDelay: "-2s" }}
      />
      <div
        className="absolute bottom-20 left-1/3 w-80 h-80 bg-gradient-to-br from-[hsl(174,72%,45%,0.1)] to-transparent rounded-full blur-3xl float-animation pointer-events-none"
      ...
      <main className="flex-1 container mx-auto px-4 py-8 relative z-10">
        ...
        <section className="mb-16 max-w-3xl mx-auto text-center space-y-8 animate-in pt-8">
          ...
          <p className="text-lg md:text-xl text-muted-foreground max-w-xl mx-auto leading-relaxed">
            Explore a curated collection of stunning visuals from our creative
            community. Share your perspective with the world.
          </p>
          ...
          <div className="text-center py-24">
            <div className="glass-card inline-block p-12 rounded-3xl">
              ...
              <p className="text-muted-foreground max-w-sm">
                Try adjusting your search or explore our featured collections.
              </p>
            </div>
          </div>
        )}
